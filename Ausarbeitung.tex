...
Des weiteren kann ein Eigenverbrauch von Solarstrom nicht, bzw. nur mit hohem Aufwand, umgesetzt werden, da über eine vorhandene \ac{NEA} sehr günstig Strom erzeugt werden kann \footnote{Aus 1 l Heizöl können 4 kWh Strom gewonnen werden}.

Neben der Trocknugnshalle steht eine hofeigene Fläche mit etwa 3 ha landwirtschaftlicher Nutzfläche zur Verfügung.
...
\subsection{Notwendigkeit Stromspeicher}
Wie in \cref{sec:betrieb} beschrieben, ist der Stromverbrauch sowohl am Tag als auch in der Nacht relativ hoch.
